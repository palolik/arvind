...
if(isset($_POST['create'])){
    ...
    while($row = $result->fetch_assoc()) { 
          echo  "<div class=proall >
                    ...
                    <div class=specification>".$row['specification']."
                    </div>
                    <div class=sdes >".$row['shortdescription']. "
                    </div>
                    <br>
                    ...
                    <div class=weight>".$row['weight']."
                    </div>
                    <div class=longdescription>".$row['longdescription']."
                    </div><div class=variation>".$row['variation']."
                    </div>
                    <br><br>
                    <div class=availability>".$row['availability']."
                    </div>
                ...
                if($result)
                {
                    while($row = $result->fetch_assoc()) { 
                        echo  "<div class='sagol' align='center'>
                                    <div>".$row['ratedIndex']."</div>
                                        <div><img src='image/review/'>".$row['image']."</div>
                                            <div><img src='image/review/'>".$row['image2']."</div>
                                                <div>".$row['image3']."</div>
                                            <div>".$row['review']."</div>
                                        <div>".$row['time']."</div>
                                    <br>
